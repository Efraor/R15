...
//     // Establece la posición inicial conocida del robot en la cancha
//     chassis.setPose(-50.44, 6.33, 90);

//     // --- Movimiento hacia casi medio ---
//     // Se mueve hacia la primera posición de recogida
//     chassis.moveToPose(-9.67, 16.21, 60, 3000, {.maxSpeed = 100}, false);
//     // Activa el rodillo para recoger bolas
//     move_roller(120);

//     // --- Movimiento al centro ---
//     // Gira el chasis para orientar el robot hacia la siguiente acción
//     chassis.swingToHeading(20, lemlib::DriveSide::LEFT, 1000, {.maxSpeed = 80});
    
//     // --- Recoger bolas ---
//     chassis.moveToPose(-3.62, 39, 0, 4000, {.maxSpeed = 30}, false); // Posición de recogida final
//     No_move_roller(); // Detiene el rodillo para evitar sobrecargar o perder bolas

//     // --- Posicionamiento para anotar ---
//     chassis.moveToPose(-24, 23.1, 45, 3000, {.forwards = false, .maxSpeed = 60}, false);

//     // --- Anotación en los goals ---
//     chassis.turnToHeading(130, 1000); // Alinea el chasis con el goal
//     chassis.moveToPose(-15., 15.41, 142, 5000, {.maxSpeed = 70}, false); // Se acerca al goal
//     piston3Puerta.set_value(true); // Abre el pistón para soltar las bolas
//     move_roller(127); // Activa rodillo para ayudar a anotar
//     pros::delay(3000); // Espera a que todas las bolas caigan
//     No_move_roller(); // Detiene el rodillo

//     // --- Preparación para volver a recoger ---
//     chassis.moveToPose(-19, 21, 120, 1000, {.forwards = false, .maxSpeed = 100}, false);
//     piston3Puerta.set_value(false); // Cierra el pistón para recoger nuevas bolas

//     // --- Movimiento hacia el otro lado de la cancha ---
//     chassis.moveToPose(-18.24, -13.74, 142, 3000, {.maxSpeed = 80}, false);
//     chassis.moveToPose(-6.10, -19, 104, 3000, {.maxSpeed = 80}, false);
//     move_roller(120); // Activa rodillo para recoger bolas
//     chassis.swingToHeading(148, lemlib::DriveSide::RIGHT, 2000, {.maxSpeed = 120}); // Gira el robot

//     // --- Posicionamiento para segunda recogida ---
//     chassis.moveToPose(0, -41.4, 180, 4000, {.maxSpeed = 30}, false);
//     No_move_roller(); // Detiene rodillo
//     chassis.turnToHeading(135, 1000); // Orienta hacia goal

//     // --- Posicionamiento para segunda anotación ---
//     chassis.moveToPose(-22.11, -25.75, 135, 3000, {.forwards = false, .maxSpeed = 100}, false);
//     chassis.turnToHeading(45, 1000);
//     chassis.moveToPose(-10, -8.57, 48.1, 3000, {.maxSpeed = 50}, false);
//     move_roller(-80); // Expulsa las bolas hacia el goal
//     pros::delay(4000); // Espera a que todas las bolas salgan
//     No_move_roller(); // Detiene rodillo
...
//     correccion(); // Función personalizada para ajustar la posición final usando tiempo y grados de giro
// }
